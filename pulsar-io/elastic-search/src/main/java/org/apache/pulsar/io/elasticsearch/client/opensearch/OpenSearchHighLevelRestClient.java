...
public class OpenSearchHighLevelRestClient extends RestClient implements BulkProcessor {
    ...
    public OpenSearchHighLevelRestClient(ElasticSearchConfig elasticSearchConfig, BulkProcessor.Listener bulkProcessorListener) throws MalformedURLException {
        ...
        RestClientBuilder builder = org.opensearch.client.RestClient.builder(new HttpHost(url.getHost(), url.getPort(), url.getProtocol()))
        ...
        if (config.isBulkEnabled()) {
            org.opensearch.action.bulk.BulkProcessor.Builder bulkBuilder = org.opensearch.action.bulk.BulkProcessor.builder(
